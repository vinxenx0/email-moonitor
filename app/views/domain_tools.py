...
def traceroute():
    ...
    breadcrumbs = [
        {"url": "/tools", "text": "Tools"},
        {"url": "/tools/domains/", "text": "Dominios"},
        {"url": "/tools/domains/traceroute", "text": "Traceroute"},
    ]
    form = DomainToolsForm()
    results = None
    is_results_valid = False
...
def aaaa_domain():
    ...
    breadcrumbs = [
        {"url": "/tools", "text": "Tools"},
        {"url": "/tools/domains/", "text": "Dominios"},
        {"url": "/tools/domains/aaaa", "text": "AAAA lookup"},
    ]
    form = DomainToolsForm()
    results = None
    is_results_valid = False
...
def ip_domain():
    ...
    breadcrumbs = [
        {"url": "/tools", "text": "Tools"},
        {"url": "/tools/domains/", "text": "Dominios"},
        {"url": "/tools/domains/ip", "text": "IP lookup"},
    ]
    form = DomainToolsForm()
    results = None
    is_results_valid = False
...
def cname_domain():
    ...
    breadcrumbs = [
        {"url": "/tools", "text": "Tools"},
        {"url": "/tools/domains/", "text": "Dominios"},
        {"url": "/tools/domains/cname", "text": "CNAME"},
    ]
    form = DomainToolsForm()
    results = None
    is_results_valid = False
...
def reverse_domain():
    ...
    breadcrumbs = [
        {"url": "/tools", "text": "Tools"},
        {"url": "/tools/domains/", "text": "Dominios"},
        {"url": "/tools/domains/reverse", "text": "Reverse"},
    ]
    form = DomainToolsForm()
    results = None
    is_results_valid = False
...
def whois_domain():
    ...
    breadcrumbs = [
        {"url": "/tools", "text": "Tools"},
        {"url": "/tools/domains/", "text": "Dominios"},
        {"url": "/tools/domains/whois", "text": "WHOIS"},
    ]
    form = DomainToolsForm()
    results = None
    is_results_valid = False
