...
def get_page_info(url):
    try:
        ...
        page_info = {
            ...
            'Security Info' : spider_tools.get_security_info(url, response, soup),
            'Common URL Issues' : spider_tools.get_common_url_issues(url),
            'Page Title Issues' : spider_tools.get_page_title_issues(soup),
            'Meta Description Issues' : spider_tools.get_meta_description_issues(soup),
            'Meta Keywords Issues' : spider_tools.get_meta_keywords_issues(soup)
        }
...
url="https://4glsp.com/productos/gestion-erp/"
page_info = spider_tools.get_page_info(url)
